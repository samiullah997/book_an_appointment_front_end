  ...
  if (reversed.length === 0) {
    return (
      <div className="flex w-full h-full justify-center items-center">
        <img src="https://www.superiorlawncareusa.com/wp-content/uploads/2020/05/loading-gif-png-5.gif" className="w-10 h-10" alt="loading" />
      </div>
    );
  }
              ...
              <div className="h-full w-2/5 bg-gray-50 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700" key={item.id}>
                ...
                <div className="p-5">
                  ...
                  <div className="flex flex-row justify-between">
                    <Link to={`/user/Details?id=${item.id}`} onClick={() => dispatch(singleBike(item.id))}>
